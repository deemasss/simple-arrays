            ...
            console.log(winArr); // Массив книг, c наибольшим кол-вом жанров одного вида

            let b20 = booksArr.filter(j => j.year < 2000).map(x => x.bookName);
            let a20 = booksArr.filter(j => j.year > 2000).map(x => x.bookName);
            console.log(b20); // Массив книг, написаных до XX века
            console.log(a20); // Массив книг, написаных после XX века